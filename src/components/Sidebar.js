...
const Sidebar = ({ onClose }) => {
	...
	return (
		<div className="fixed bg-[#000000aa] w-full top-0 h-full z-50">
			<div className="fixed inset-y-0 left-0 md:w-2/3 w-full bg-gray-100 p-4 overflow-auto shadow-lg">
				...
				{dashboard
					...
					?.widgets.map((widget) => (
						<div
							key={widget.id}
							className="flex p-3 border bg-gray-200 items-center mb-2"
						>
							<input
								type="checkbox"
